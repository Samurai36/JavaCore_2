...
public class Main {
    ...
    static void metod1() {
        ...
        System.out.println((System.currentTimeMillis() - a) + "мс - время выполнения первого метода");
    }

    static void metod3(float arr[]) {
    ...
    static void metod2() {
        ...
        System.out.println((System.currentTimeMillis() - a) + "мс - время выполнения второго метода");
    }
